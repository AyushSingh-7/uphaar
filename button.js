!function() {
    ...
    Array.prototype.fill || Object.defineProperty(Array.prototype, "fill", {
        value: function(t) {
            ...
            for (var e = Object(this), n = e.length >>> 0, r = arguments[1] >> 0, o = r < 0 ? Math.max(n + r, 0) : Math.min(r, n), r = arguments[2], r = void 0 === r ? n : r >> 0, i = r < 0 ? Math.max(n + r, 0) : Math.min(r, n); o < i; )
                e[o] = t,
                o++;
            return e
        }
    ...
    function(t) {
        ...
        for (var o, i = c(e.length), a = u(this) ? Object(new this(i)) : new Array(i), s = 0; s < i; )
            o = e[s],
    ...
    "currentScript"in (l = document) || Object.defineProperty(l, "currentScript", {
        get: function() {
            try {
                ...
                var e, n = 0, r = /.*at [^(]*\((.*):(.+):(.+)\)$/gi.exec(t.stack), o = r && r[1] || !1, i = r && r[2] || !1, a = l.location.href.replace(l.location.hash, ""), s = l.getElementsByTagName("script");
                for (o === a && (r = l.documentElement.outerHTML,
                i = new RegExp("(?:[^\\n]+?\\n){0," + (i - 2) + "}[^<]*<script>([\\d\\D]*?)<\\/script>[\\d\\D]*","i"),
                e = r.replace(i, "$1").trim()); n < s.length; n++) {
    ...
    (tt = {
        ...
        ) : i ? ((p = new MessageChannel).port1.onmessage = d,
        function() {
        ...
        function _(t, e, n) {
            var o, i, r, a;
            e.constructor === t.constructor && n === v && e.constructor.resolve === b ? (r = t,
            1 === (a = e)._state ? E(r, a._result) : 2 === a._state ? P(r, a._result) : O(a, void 0, function(t) {
                return x(r, t)
            }, function(t) {
                return P(r, t)
            })) : void 0 !== n && u(n) ? (o = e,
        ...
        j.prototype._eachEntry = function(e, t) {
            ...
            if (r === b) {
                ...
                i === v && void 0 !== e._state ? this._settledAt(e._state, t, e._result) : "function" != typeof i ? (this._remaining--,
                this._result[t] = e) : n === R ? (o = new n(w),
                s ? P(o, a) : _(o, e, i),
        ...
        function j(t, e) {
            ...
            this._enumerate(e),
            0 === this._remaining && E(this.promise, this._result))) : P(this.promise, new Error("Array Methods must be provided an Array"))
        }
        ...
        if (!q) {
            ...
            do {
                for (var t = 0; t < z.length; t += 1) {
                    ...
                    o = e.$$,
                    e = void 0,
                    void (null !== o.fragment && (o.update(),
                    y(o.before_update),
                    e = o.dirty,
                    o.dirty = [-1],
                    o.fragment && o.fragment.p(o.ctx, e),
                    o.after_update.forEach(F)))
                }
                for (z.length = 0; L.length; )
                    L.pop()();
    ...
    function G(t, e) {
        t = t.$$;
        null !== t.fragment && (y(t.on_destroy),
    ...
    function Y(r, t, e, n, o, i, a) {
        ...
        c.ctx = e ? e(r, u, function(t, e) {
            ...
            return c.ctx && o(c.ctx[t], c.ctx[t] = n) && (!c.skip_bound && c.bound[t] && c.bound[t](n),
            f && (n = t,
            -1 === (t = r).$$.dirty[0] && (z.push(t),
            U || (U = !0,
            D.then(Q)),
            t.$$.dirty.fill(0)),
        ...
        t.target && (t.hydrate ? (n = t.target,
        n = Array.from(n.childNodes),
        c.fragment && c.fragment.l(n),
        n.forEach(P)) : c.fragment && c.fragment.c(),
        t.intro && J(r.$$.fragment),
        W(r, t.target, t.anchor),
        Q()),
        R(s)
    }
    ...
    ,
    ht.$set = function(t) {
        this.$$set && 0 !== Object.keys(t).length && (this.$$.skip_bound = !0,
        this.$$set(t),
        this.$$.skip_bound = !1)
    }
    ,
    ...
    function at(t, e) {
        var n;
        t && ((n = document.createElement("script")).src = t,
        n.onload = e,
    ...
    var ut, ct = ((ht = {}).lj = "96df432a283745908a06f711acd9e5eb",
    ht), ft = ["ga", "hotjar", "perf"], lt = {
        ...
        init: function(t, e) {
            ...
            void 0 === e && (e = "native"),
            window.rzpQ || (n = t,
            window.analytics ? window.analytics.createQ && (window.rzpQ = window.analytics.createQ({
                pollFreq: 500
            })) : (t = function() {}
            ,
        ...
        init: function(r, o) {
            at("https://cdn.razorpay.com/static/analytics/bundle.js", function() {
                var e, n;
                void 0 === (t = ["lj"]) && (t = ft),
                window.razorpayAnalytics || window.analytics ? (e = [],
                n = {},
    ...
    function yt(t) {
        ...
        return {
            c: function() {
                B(n = O("div"), "class", "razorpay-loader svelte-q4m8xw"),
                B(n, "style", r = t[0] ? "opacity: 1" : "")
            },
            m: function(t, e) {
                E(t, n, e)
            },
    ...
    (0,
    window[ht])("attachEvent" == ht ? "onmessage" : "message", function(t) {
        event.origin;
        var e, n = t[t.message ? "message" : "data"];
        switch (st(n.event_type, n.data),
        n.event_type) {
        case "close_modal":
            st(),
            it({
    ...
    function _t(n) {
        ...
        return {
            ...
            p: function(t, e) {
                var n = b(e, 1)[0];
                (!l || 32 & n) && B(i, "style", t[5]),
                (!l || 16 & n) && B(o, "style", t[4]);
                e = {};
                2 & n && (e.show = t[1]),
                d.$set(e),
                (!l || 1 & n && c.src !== (f = t[0])) && B(c, "src", f),
                (!l || 4 & n) && B(r, "style", t[2])
            },
            i: function(t) {
                l || (J(d.$$.fragment, t),
    ...
    function xt(t, e, n) {
        ...
        return r.isQATestMode && (u = r.paymentButtonOptions.payment_button_id,
        ...
        t.$$.update = function() {
            ...
            8 & t.$$.dirty && (r.isPaymentFormOpened ? (n(1, o = !0),
            r.isIframeContentsLoaded && setTimeout(function() {
                n(1, o = !1)
            }, 1e3)) : n(1, o = !1))
        }
        ,
    ...
    function Ot(t) {
        ...
        return document.getElementById("svelte-7tbrl8-style") || ((e = O("style")).id = "svelte-7tbrl8-style",
    ...
    function St(t) {
        ...
        return {
            c: function() {
                n = S("Secured by "),
                B(r = O("img"), "class", "secured-by-logo svelte-ekc7fv"),
                r.src !== (e = t[4]) && B(r, "src", e),
                B(r, "alt", "brand"),
                B(r, "height", "14px")
            },
            m: function(t, e) {
    ...
    function $t(o) {
        ...
        return {
            ...
            p: function(t, e) {
                ...
                1 & e && T(c, t[0]),
                v.p(t, e),
                2 & e && n !== (n = x(t[1]) + " svelte-ekc7fv") && B(i, "class", n),
                4 & e && j(i, "background", t[2] || "")
            },
            i: g,
            o: g,
            d: function(t) {
    ...
    function Bt(n, t, e) {
        ...
        var o, i = t.brandColor, a = t.buttonTheme, s = t.buttonText, u = t.brandingOptions, s = s.substring(0, 20), c = void 0 === u.show_rzp_logo || u.show_rzp_logo, f = u.branding_logo, l = r.paymentFormUrl + "/?utm_source=payment_button&utm_medium=button&utm_campaign=payment_button", d = -1 < [Pt.RZP_DARK_STANDARD, Pt.RZP_LIGHT_STANDARD, Pt.RZP_OUTLINE_STANDARD].indexOf(a), p = !0;
        return d ? Pt.RZP_DARK_STANDARD === a && (p = !1) : (o = Pt.BRAND_COLOR === a ? i : a,
        p = !(colorLib && colorLib.isDark(o))),
        t = "PaymentButton",
        t += " PaymentButton--" + (p ? "light" : "dark"),
        d && (t += " PaymentButton--rzpTheme",
        t += " PaymentButton--" + a),
        ...
        [s, t, o, c, f, l, i, a, u, function(t) {
            var e;
            e = t,
            (t = n.$$.callbacks[e.type]) && t.slice().forEach(function(t) {
                return t(e)
            })
        }
        ]
    }
    var Tt, jt = (o(Rt, Tt = tt),
    t(Rt, [{
        key: "brandColor",
        get: function() {
            return this.$$.ctx[6]
    ...
    function Rt(t) {
        ...
        return document.getElementById("svelte-ekc7fv-style") || ((e = O("style")).id = "svelte-ekc7fv-style",
        e.textContent = "@import url(\"https://fonts.googleapis.com/css2?family=Muli:wght@700;800&display=swap\");.PaymentButton.svelte-ekc7fv.svelte-ekc7fv{position:relative;display:inline-block;width:400px;height:70px;padding:0;border-radius:1rem;text-align:center;font-style:italic;font-family:Muli,helvetica,sans-serif;font-display:swap;overflow:hidden;border:1px solid transparent;outline:none;cursor:pointer;-webkit-tap-highlight-color:transparent;text-decoration:none}.PaymentButton--customSecuredByLogo.svelte-ekc7fv.svelte-ekc7fv{height:48px}.PaymentButton--light.svelte-ekc7fv.svelte-ekc7fv{color:#072654}.PaymentButton--dark.svelte-ekc7fv.svelte-ekc7fv{color:#fff}.PaymentButton--rzp-dark-standard.svelte-ekc7fv.svelte-ekc7fv:hover{background-color: darkgreen}.PaymentButton--rzp-dark-standard.svelte-ekc7fv.svelte-ekc7fv{background: green;border-color:#072654}.PaymentButton--rzp-outline-standard.svelte-ekc7fv.svelte-ekc7fv{background:#eaf2fe;border-color:#1e40a0}.PaymentButton--rzp-outline-standard.svelte-ekc7fv.svelte-ekc7fv::before{box-shadow:2px 0 4px rgba(0,0,0,0.15)}.PaymentButton--rzp-light-standard.svelte-ekc7fv.svelte-ekc7fv{background:#fff;border-color:#fff}.PaymentButton--rzp-light-standard.svelte-ekc7fv.svelte-ekc7fv::before{box-shadow:2px 0 4px rgba(0,0,0,0.15)}svg.svelte-ekc7fv.svelte-ekc7fv{position:absolute;top:0;left:0;margin:9px 11px}svg.svelte-ekc7fv svg path.svelte-ekc7fv{fill:#fff}.PaymentButton--rzpTheme.svelte-ekc7fv svg path.svelte-ekc7fv{fill:#fff}.PaymentButton--light.svelte-ekc7fv:not(.PaymentButton--rzpTheme) svg path.svelte-ekc7fv{fill:#072654}.PaymentButton.svelte-ekc7fv.svelte-ekc7fv:not(.PaymentButton--rzpTheme):not(.PaymentButton--noRzpLogo)::before{content:'';position:absolute;bottom:0;left:0;top:0;right:0;background:linear-gradient(121deg,rgba(255,255,255,0) 40%,rgba(255,255,255,0.2) 100%)}.PaymentButton-contents.svelte-ekc7fv.svelte-ekc7fv{padding:4px 28px 4px 44px;margin:1px 0}.PaymentButton--noRzpLogo.svelte-ekc7fv .PaymentButton-contents.svelte-ekc7fv{padding-left:28px !important}.PaymentButton--rzpTheme.svelte-ekc7fv .PaymentButton-contents.svelte-ekc7fv{padding-left:60px}.PaymentButton-text.svelte-ekc7fv.svelte-ekc7fv{display:block;margin-top:1.1rem;min-height:18px;line-height:18px;font-size:2rem;font-weight:800;opacity:1;text-transform:initial}.PaymentButton-securedBy.svelte-ekc7fv.svelte-ekc7fv{font-size:8px;line-height:10px;text-transform:initial;margin-top:0;opacity:.6}.PaymentButton--customSecuredByLogo.svelte-ekc7fv .PaymentButton-securedBy.svelte-ekc7fv{opacity:1;margin-top:1px}.secured-by-logo.svelte-ekc7fv.svelte-ekc7fv{vertical-align:middle}",
        k(document.head, e)),
        Y(i(n), t, Bt, $t, w, {
            brandColor: 6,
            buttonTheme: 7,
    ...
    function Ct(t, e, n) {
        ...
        function c(t) {
            var n, r, e = i.paymentButtonOptions, o = (n = i.paymentButtonOptions,
            r = {},
        ...
        return a = i.buttonPreferences.data.merchant_brand_color,
        o = u.button_text,
        r = u.button_theme,
        ...
        t.$$.update = function() {
            96 & t.$$.dirty && i.isPaymentFormOpened && i.isIframeContentsLoaded && function(t) {
                ...
                var e = ot()
                  , n = e.modalFrameEl;
                e.isQATestMode && (e = e.baseUrl,
                t.base_url = e.replace("/v1", "")),
    ...
    var Lt, Nt, Mt = (o(Dt, Nt = tt),
    Dt);
    function Dt(t) {
        var e;
        return Y(i(e = Nt.call(this) || this), t, Ct, zt, w, {}),
        e
    }
    function Ut(e, n) {
        function t() {
            var t;
            Lt = !1 !== (t = e).defaultIntegrations ? (window.Sentry.init(t),
            window.Sentry) : (t.integrations = [new window.Sentry.Integrations.InboundFilters, new window.Sentry.Integrations.FunctionToString, new window.Sentry.Integrations.Breadcrumbs, new window.Sentry.Integrations.LinkedErrors, new window.Sentry.Integrations.UserAgent],
    ...
    function Ft(e) {
        if (Lt && e)
            return Lt.run ? Lt.run(function(t) {
                t.captureException(e)
            }) : void Lt.captureException(e)
    }
    var qt = [];
    function It() {
        qt.length && Lt && qt.forEach(Ft),
        qt = []
    }
    ...
    function Jt(t) {
        ...
        return ~(o = u(t)) && (i = s[o] = a[o](t)),
        {
            c: function() {
                r = O("span"),
                i && i.c(),
                B(r, "class", "razorpay-payment-button svelte-ohbfj8")
            },
            m: function(t, e) {
                E(t, r, e),
                ~o && s[o].m(r, null),
    ...
    var Vt, Wt = (o(Yt, Vt = tt),
    Yt), Gt = Object.prototype.toString;
    function Yt(t) {
        var e, n = Vt.call(this) || this;
        return Qt.getElementById("svelte-ohbfj8-style") || ((e = O("style")).id = "svelte-ohbfj8-style",
        e.textContent = ".razorpay-payment-button.svelte-ohbfj8,.razorpay-payment-button.svelte-ohbfj8 *,.razorpay-payment-button.svelte-ohbfj8 *::before,.razorpay-payment-button.svelte-ohbfj8 *::after{box-sizing:border-box}.razorpay-payment-button.svelte-ohbfj8{position:relative;display:inline-block;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}",
        k(Qt.head, e)),
        Y(i(n), t, Kt, Jt, w, {}),
        n
    }
    ...
    function ue(t, e, n) {
        return e && (n = n ? n(e) : ae.isURLSearchParams(e) ? e.toString() : (r = [],
        ae.forEach(e, function(t, e) {
            null != t && (ae.isArray(t) ? e += "[]" : t = [t],
            ae.forEach(t, function(t) {
                ae.isDate(t) ? t = t.toISOString() : ae.isObject(t) && (t = JSON.stringify(t)),
                r.push(se(e) + "=" + se(t))
            }))
        }),
    ...
    ;
    var he, me, ye, ve = ce, be = ae.isStandardBrowserEnv() ? {
        ...
        remove: function() {}
    }, ge = ["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"], we = ae.isStandardBrowserEnv() ? (me = /(msie|trident)/i.test(navigator.userAgent),
    ...
    function xe(t) {
        return me && (ye.setAttribute("href", t),
        t = ye.href),
    ...
    var Ee = {
        adapter: (("undefined" != typeof XMLHttpRequest || "undefined" != typeof process && "[object process]" === Object.prototype.toString.call(process)) && (Le = function(f) {
            return new Promise(function(s, u) {
                ...
                f.auth && (i = f.auth.username || "",
                t = f.auth.password ? unescape(encodeURIComponent(f.auth.password)) : "",
                r.Authorization = "Basic " + btoa(i + ":" + t));
                var t, e, o, i = (e = f.baseURL,
                i = f.url,
                e && !/^([a-z][a-z\d\+\-\.]*:)?\/\//i.test(i) ? (t = e,
                (e = i) ? t.replace(/\/+$/, "") + "/" + e.replace(/^\/+/, "") : t) : i);
                if (c.open(f.method.toUpperCase(), ue(i, f.params, f.paramsSerializer), !0),
                c.timeout = f.timeout,
                c.onreadystatechange = function() {
                    var e, n, r, t, o, i, a;
                    c && 4 === c.readyState && (0 !== c.status || c.responseURL && 0 === c.responseURL.indexOf("file:")) && (i = "getAllResponseHeaders"in c ? (o = c.getAllResponseHeaders(),
                    r = {},
                    o && ae.forEach(o.split("\n"), function(t) {
                        n = t.indexOf(":"),
                ...
                ,
                c.onabort = function() {
                    c && (u(pe("Request aborted", f, "ECONNABORTED", c)),
                    c = null)
                }
                ,
                c.onerror = function() {
                    u(pe("Network Error", f, null, c)),
                    c = null
                }
                ,
        ...
        transformRequest: [function(t, e) {
            return de(e, "Accept"),
            de(e, "Content-Type"),
            ae.isFormData(t) || ae.isArrayBuffer(t) || ae.isBuffer(t) || ae.isStream(t) || ae.isFile(t) || ae.isBlob(t) ? t : ae.isArrayBufferView(t) ? t.buffer : ae.isURLSearchParams(t) ? (ke(e, "application/x-www-form-urlencoded;charset=utf-8"),
            t.toString()) : ae.isObject(t) ? (ke(e, "application/json;charset=utf-8"),
            JSON.stringify(t)) : t
        }
        ],
    ...
    function Ae(e) {
        ...
        (e.adapter || Pe.adapter)(e).then(function(t) {
            return Oe(e),
            t.data = fe(t.data, t.headers, e.transformResponse),
            t
        }, function(t) {
            return le(t) || (Oe(e),
            t && t.response && (t.response.data = fe(t.response.data, t.response.headers, e.transformResponse))),
            Promise.reject(t)
        })
    }
    function Se(e, n) {
    ...
    $e.prototype.getUri = function(t) {
        return t = Se(this.defaults, t),
        ue(t.url, t.params, t.paramsSerializer).replace(/^\?/, "")
    }
    ,
    ...
    function ze(t) {
        ...
        return ae.extend(t, Be.prototype, e),
        ae.extend(t, e),
        t
    }
    var Ce = ze(Pe);
    ...
    function Me(t, e) {
        ...
        function(t, e) {
            ...
            n.paymentFormUrl = "https://razorpay.com/payment-button/" + t + "/view",
            rt.set(n)
        }(e, r),
        function() {
            st();
    ...
    tt = document.currentScript,
    "FORM" !== (Le = tt.parentElement).tagName && window.alert("Payment Button is not added. Add Button script inside 'form' tag."),
    tt = tt.dataset,
    st(),
    Me(Le, tt)
}();
